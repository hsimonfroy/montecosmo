...
if __name__ == '__main__':
    ...
    # fastpm fNL=0, 32^3
    infer(register_name='register_fastpm_fNL0_z1.000_LRG_b32_p0.h5',
          png_type=None, lik_type='shash', evolution='lpt',
          self_data=False, fnl=0., expe='eft2', overwrite=False)
